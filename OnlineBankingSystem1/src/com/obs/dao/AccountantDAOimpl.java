...
import com.obs.exception.AccountException;
	...
	public class AccountantDAOimpl implements AccountantDAO{
		...
		@Override
		public AccountantBean LoginAccountant(String uname, String password) throws AccountantException {
			
			AccountantBean acc = null;
			
			try(Connection conn = DBUtil.provideConnection()) {
				
			PreparedStatement ps= conn.prepareStatement("select * from InfoAccountant where ename = ? AND epass = ?");			
